...
transform_task = GlueJobOperator(
    ...
    script_location='s3://aws-glue-assets-112207118291-ap-south-1/scripts/weather_data_ingestion.py',
    s3_bucket='s3://aws-glue-assets-112207118291-ap-south-1',  # S3 bucket where logs and local etl script will be uploaded
